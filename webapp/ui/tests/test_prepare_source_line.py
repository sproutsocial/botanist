...
class PrepareSourceLine(TestCase):
    def test_html_in_source_line_is_escaped_but_span_for_highlight_is_not(self):
        ...
        expected = (
            r'    &lt;!-- <span class="highlighted-search-query">TODO</span>: need to clean up these colors below--&gt;'
        )
    ...
    def test_regex_query_match_is_highlighted_case_insensitive(self):
        query = r"todo"
        test_cases = (
            (r"    #TODO change this", '    #<span class="highlighted-search-query">TODO</span> change this'),
            (
                r"        // todo do something cool",
                '        // <span class="highlighted-search-query">todo</span> do something cool',
            ),
        )
    ...
    def test_prep_search_line_with_html_disabled(self):
        query = r"todo"
        test_cases = (
            (r"    #TODO change this", "    #TODO change this"),
            (r"        // todo do something cool", "        // todo do something cool"),
        )
