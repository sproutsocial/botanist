...
class ParseSearchResults(TestCase):
    def test_basic_parse_search_results(self, get_repo_type):
        ...
        self.assertEqual(
            "https://github.com/org1/repo1/blob/main/src/main/java/com/sproutsocial/SomeClass.java#L148",
    ...
    def test_duplicate_repositories_in_github_and_bitbucket(self, get_repo_type):
        ...
        self.assertEqual(
            ...
            results["org1/sproutjobs"]["bitbucket"]["files"]["src/main/java/com/sproutsocial/AbstractJob.java"][0][
                "srcline"
            ],
        )
        self.assertEqual(
            "public abstract class AbstractJob implements Job {",
            results["org1/sproutjobs"]["github"]["files"]["src/main/java/com/sproutsocial/AbstractJob.java"][0][
                "srcline"
            ],
        )
