...
class DeepLink(TestMixin, TestCase):
    ...
    def test_deep_link_bitbucket_git_with_lineno(self):
        ...
        self.assertEqual(
            "https://bitbucket.org/org-name/git-repo-name/src/main/somedir/sourcefile.py#sourcefile.py-42", dl
        )
    ...
    def test_deep_link_bitbucket_hg_with_lineno(self):
        ...
        self.assertEqual(
            "https://bitbucket.org/org-name/hg-repo-name/src/default/somedir/sourcefile.py#sourcefile.py-42", dl
        )
